...
@Category({ Categories.setId.class, Categories.roostTestTag1.class, Categories.roostTestTag2.class })
public class ProductSetIdTest {
	...
	public void setIdWithValidId() {
		...
		Assert.assertEquals("The ID should be set to the valid ID", validId, product.getId());
	}

	@Test
	public void setIdWithNull() {
		product.setId(null);
		Assert.assertNull("The ID should be set to null", product.getId());
	}
	...
	public void setIdWithNegativeId() {
		...
		Assert.assertEquals("The ID should be set to the negative ID", negativeId, product.getId());
	}
	...
	public void setIdWithZero() {
		...
		Assert.assertEquals("The ID should be set to zero", zeroId, product.getId());
	}
